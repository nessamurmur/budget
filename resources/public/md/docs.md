...
Two middleware functions are provided by default in the `budget.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `budget.handler` namespace to manage the enabled middleware.
